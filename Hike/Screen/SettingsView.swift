    ...
    var body: some View {
        List {
            ...
            Section(header: Text("Alternate Icons")) {
                ...
                Text("Choose your favorite app icon from the collection abeve.")
...
//                LabeledContent("Application", value: "Hike")
                ...
                CustomListRowView(rowLabel: "Developer", rowIcon: "ellipsis.curlybraces", rowContent: "Victor Catao", rowTintColor: .mint)
